...
export function NavbarAdmin() {
  return(
    <header className="h-15 bg-white border-b border-border-ccv flex items-center justify-between px-8 flex-shrink-0">
      {/* 🔧 DINÁMICO: título de la sección activa */}
      <h1 className="text-[17px] font-semibold text-text-ccv">Dashboard</h1>

      <div className="flex items-center gap-3">
        {/* 🔧 DINÁMICO: ciclo escolar activo */}
        <h2 className="text-[12px] text-muted-ccv bg-bg-ccv border border-border-ccv px-[13px] py-[5px] rounded-[7px]">Ciclo escolar</h2>

        {/* 🔧 DINÁMICO: rol del usuario autenticado */}
        <h2 className="text-[11px] font-semibold text-white bg-primary-ccv px-3 py-[5px] rounded-[7px]">Rol</h2>
      </div>
    </header>
  );
}